...
def add_more_songs_for_artist(playlist_url: str, artist_id: str, num_songs: int) -> list[str]:
    """_summary_
    ...
    ## BEGIN REQUEST ##
    # Get the spotify artist
    top_tracks = spotify_user.execute('artist_top_tracks', artist_id).get('tracks', [])
    sleep(RequestType.SPOTIFY)
    ## END REQUEST ##
